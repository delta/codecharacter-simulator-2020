...
class StateSyncerTest : public Test {
  public:
    ...
    StateSyncerTest() {
        ...
        // Updating the map to show positions of towers
        dummy_map[0][0] = state::TerrainType::TOWER;
        dummy_map[map_size - 1][map_size - 1] = state::TerrainType::TOWER;
...
TEST_F(StateSyncerTest, updatePlayerStates) {
    ...
    auto bot2 = new state::Bot(Actor::getNextActorId(), PlayerId::PLAYER1,
                               ActorType::BOT, 100, 100, DoubleVec2D(3, 3), 1,
                               1, 1, BlastCallback{});
    ...
    auto state_tower2 = new state::Tower(
        Actor::getNextActorId(), PlayerId::PLAYER2, ActorType::TOWER, 100, 100,
        DoubleVec2D(3, 2), 2, 2, BlastCallback{});
    ...
    ASSERT_EQ(player_states[0].enemy_towers[1].position, DoubleVec2D(3, 2));
    ...
    ASSERT_EQ(player_states[1].bots[0].position, DoubleVec2D(4, 4));
