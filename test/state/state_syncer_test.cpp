...
TEST_F(StateSyncerTest, updatePlayerStates) {
    ...
    EXPECT_EQ(player_states[1].towers[1].position, DoubleVec2D(0, 1));
    ...
    EXPECT_EQ(player_states[0].map[0][0].getTerrain(), T);
    EXPECT_EQ(player_states[1].map[4][4].getTerrain(), T);
    ...
    EXPECT_EQ(player_states[1].towers[0].position, DoubleVec2D(0, 0));
